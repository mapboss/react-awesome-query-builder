...
var mongodbFormat = function mongodbFormat(item, config) {
  ...
  if (type === 'group' && children && children.size) {
    ...
    var _fieldWidgetDefinition = (0, _omit.default)((0, _configUtils.getFieldWidgetConfig)(config, field, operator, widget), ['factory']);

    var typeConfig = config.types[fieldDefinition.type] || {}; // let operatorOptions = options ? options.toJS() : null;
    ...
    value = value.map(function (currentValue, ind) {
      ...
      if (valueSrc == 'field') {
        ...
        if (typeof fieldWidgetDefinition.mongoFormatValue === 'function') {
          ...
          var _args = [currentValue, (0, _pick.default)(fieldDefinition, ['fieldSettings', 'listValues']), (0, _omit.default)(fieldWidgetDefinition, ['formatValue', 'mongoFormatValue'])];
