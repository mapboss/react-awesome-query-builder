...
var validateTree = function validateTree(tree, oldTree, config, oldConfig) {
  ...
  var _validateItem = function _validateItem(item) {
    ...
    if (type === 'group' && children && children.size) {
      ...
      var conjunctionDefinition = config.conjunctions[conjunction]; //validate children
      ...
      var typeConfig = fieldDefinition ? config.types[fieldDefinition.type] : null; //validate operator
