...
exports.default = exports._getNewValueForFieldOp = void 0;
...
var addNewGroup = function addNewGroup(state, path, properties, config) {
  ...
  state = addItem(state, groupPath, 'rule', (0, _uuid.default)(), (0, _defaultUtils.defaultRuleProperties)(config).merge(properties || {}));
...
var _getNewValueForFieldOp = function _getNewValueForFieldOp(config) {
...
exports._getNewValueForFieldOp = _getNewValueForFieldOp;
...
var _validateValue = function _validateValue(config, field, operator, value, valueType, valueSrc) {
  ...
  var fieldWidgetDefinition = (0, _omit.default)((0, _configUtils.getFieldWidgetConfig)(config, field, operator, w, vSrc), ['factory', 'formatValue']);
  var isValid = true;
  ...
  if (v != null) {
    ...
    if (typeof fn == 'function') {
      ...
      isValid = isValid && fn.apply(void 0, args);
    }
  }
...
var setField = function setField(state, path, newField, config) {
  ...
  return state.updateIn((0, _treeUtils.expandTreePath)(path, 'properties'), function (map) {
    return map.withMutations(function (current) {
      var currentField = current.get('field');
      var currentOperator = current.get('operator');
      var currentOperatorOptions = current.get('operatorOptions'); //const currentValue = current.get('value');
