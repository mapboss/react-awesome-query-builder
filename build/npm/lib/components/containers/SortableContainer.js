...
var _default = function _default(Builder) {
  ...
  var ConnectedSortableContainer =
  /*#__PURE__*/
  function (_PureComponent) {
    _inherits(ConnectedSortableContainer, _PureComponent);
    ...
    function ConnectedSortableContainer(props) {
      ...
      _this = _possibleConstructorReturn(this, _getPrototypeOf(ConnectedSortableContainer).call(this, props));

      _defineProperty(_assertThisInitialized(_assertThisInitialized(_this)), "onDragStart", function (id, dom, e) {
    ...
    _createClass(ConnectedSortableContainer, [{
      ...
      value: function handleDrag(dragInfo, e, canMoveFn) {
        ...
        var moveInfo = null;
        var treeEl = this.props.dragStart.treeEl; //var treeElContainer = this.props.dragStart.treeElContainer;
        //var scrollTop = treeElContainer.scrollTop;
  ...
  _defineProperty(ConnectedSortableContainer, "propTypes", {
